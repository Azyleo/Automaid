...
(cl:defmethod cl:initialize-instance :after ((m <test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_pkg-msg:<test> is deprecated: use test_pkg-msg:test instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:message-val is deprecated.  Use test_pkg-msg:message instead.")
  (message m))
