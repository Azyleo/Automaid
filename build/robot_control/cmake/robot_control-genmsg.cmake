...
set(MSG_I_FLAGS "-Irobot_control:C:/Automaid/src/robot_control/msg;-Istd_msgs:C:/opt/ros/melodic/x64/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "C:/Automaid/src/robot_control/msg/rc.msg" NAME_WE)
add_custom_target(_robot_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_control" "C:/Automaid/src/robot_control/msg/rc.msg" ""
)
...
_generate_msg_cpp(robot_control
  "C:/Automaid/src/robot_control/msg/rc.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_control)
  install(CODE "execute_process(COMMAND \"C:/opt/python27amd64/python.exe\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_control\")")
  # install generated code
  install(
