...
set(MSG_I_FLAGS "-Itest_pkg:C:/Automaid/src/test_pkg/msg;-Istd_msgs:C:/opt/ros/melodic/x64/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "C:/Automaid/src/test_pkg/msg/test.msg" NAME_WE)
add_custom_target(_test_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test_pkg" "C:/Automaid/src/test_pkg/msg/test.msg" ""
)
...
_generate_msg_cpp(test_pkg
  "C:/Automaid/src/test_pkg/msg/test.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_pkg)
  install(CODE "execute_process(COMMAND \"C:/opt/python27amd64/python.exe\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test_pkg\")")
  # install generated code
  install(
